...
void UsbSetAddress()
{
	...
	IOWR(CY7C67200_BASE,HPI_DATA,0x00D0);		//PID(SETUP) and Endipoint Number(0)
												//Device Address (DevAdd)
	IOWR(CY7C67200_BASE,HPI_DATA,0x0001);		//TD Control
												//Transaction Status
	IOWR(CY7C67200_BASE,HPI_DATA,0x0013);		//Active Flag, Transfer Type, Retry Count
												//Residue
	...
	IOWR(CY7C67200_BASE,HPI_DATA,0x0000);	//BaseAddress
	IOWR(CY7C67200_BASE,HPI_DATA,0x0000);	//Port Number and Data Length
	IOWR(CY7C67200_BASE,HPI_DATA,0x0090);	//PID(IN) and Endpoint Number(0) and Device Address
	IOWR(CY7C67200_BASE,HPI_DATA,0x0041);	//TD control and Transaction Status
	IOWR(CY7C67200_BASE,HPI_DATA,0x0013);	//Active Flag, Transfer Type, Retry Count and Residue
