...
int main(void)
{
	...
	while(1)
	{
		...
		/* Testing code by Kirthi */
		int keycode_three_four = 0;
		/* End of testing code */

		IOWR(CY7C67200_BASE,HPI_ADDR,0x051e);
		keycode = IORD(CY7C67200_BASE,HPI_DATA);
		keycode_three_four = IORD(CY7C67200_BASE + 1,HPI_DATA);
		printf("\nfirst two keycode values are %04x and the second two are %04x\n",keycode, keycode_three_four);
		IOWR(KEYCODE_BASE, 0, keycode & 0xff);
		IOWR(KEYCODE_BASE, 0, keycode_three_four & 0xff);
